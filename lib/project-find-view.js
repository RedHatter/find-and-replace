...
class ProjectFindView {
  ...
  didShow() {
    ...
    this.tooltipSubscriptions = new CompositeDisposable(
      ...
      atom.tooltips.add(this.refs.functionOptionButton, {
        title: "Use Function",
        keyBindingCommand: 'project-find:toggle-function-option',
        keyBindingTarget: this.findEditor.element
      }),
  ...
  handleEvents() {
    ...
    this.subscriptions.add(atom.commands.add(this.element, {
      ...
      'project-find:toggle-function-option': () => this.toggleFunctionOption()
    }));
    ...
    this.refs.functionOptionButton.addEventListener('click', () => this.toggleFunctionOption());
